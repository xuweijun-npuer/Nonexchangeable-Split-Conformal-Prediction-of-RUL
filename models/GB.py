...
GB= HistGradientBoostingRegressor(loss = "squared_error", random_state = random_state)
GB.fit(X_train, y_train)
print("GB fitting finished!")
test_rmse = np.sqrt(mean_squared_error(y_test, GB.predict(X_test)))

y_hat_train = GB.predict(X_train)
y_hat_calibration = GB.predict(X_calibration)
...
plt.plot_two_intervals(total_prediction_results_dictionary["intervals"]["SCP"],
                       ...
                       total_prediction_results_dictionary["Groundtruth RULs"],
                       color = ["silver","pink"],
                       label = ["GB-SCP intervals ","GB-NSCP intervals","Overlapped intervals"])
...
plt.plot_two_intervals(total_prediction_results_dictionary["intervals"]["SCP"],
                       ...
                       total_prediction_results_dictionary["Groundtruth RULs"],
                       color = ["silver","pink"],
                       label = ["GB-SCP intervals ","GB-SCPN intervals","Overlapped intervals"])
...
plt.plot_two_intervals(total_prediction_results_dictionary["intervals"]["SCPN"],
                       ...
                       total_prediction_results_dictionary["Groundtruth RULs"],
                       color = ["silver","pink"],
                       label = ["GB-SCPN intervals ","GB-NSCP intervals","Overlapped intervals"])
...
plt.plot_two_intervals(total_prediction_results_dictionary["intervals"]["SCP"],
                       ...
                       total_prediction_results_dictionary["Groundtruth RULs"],
                       color = ["silver","pink"],
                       label = ["GB-SCP intervals ","GB-NSCPN intervals","Overlapped intervals"])
...
plt.plot_two_intervals(total_prediction_results_dictionary["intervals"]["NSCP"],
                       ...
                       total_prediction_results_dictionary["Groundtruth RULs"],
                       color = ["silver","pink"],
                       label = ["GB-NSCP intervals ","GB-NSCPN intervals","Overlapped intervals"])
...
plt.plot_two_intervals(total_prediction_results_dictionary["intervals"]["SCPN"],
                       ...
                       total_prediction_results_dictionary["Groundtruth RULs"],
                       color = ["silver","pink"],
                       label = ["GB-SCPN intervals ","GB-NSCPN intervals","Overlapped intervals"])
